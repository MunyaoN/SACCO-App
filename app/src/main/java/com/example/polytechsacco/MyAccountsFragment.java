...
public class MyAccountsFragment extends Fragment {
    ...
    public static MyAccountsFragment newInstance(String param1, String param2) {
    ...
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,//remove nonull
                             Bundle savedInstanceState) {


        // Inflate the layout for this fragment
        View view= inflater.inflate(R.layout.fragment_my_accounts,container,true);
        return view;
    }
}